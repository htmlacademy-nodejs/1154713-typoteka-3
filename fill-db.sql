...
INSERT INTO publications(publication_date, picture, full_text, title, announce, user_id) VALUES
  ('1/18/1999', null, 'Ёлки — это не просто красивое дерево. Это прочная древесина.', 'Ёлки. История деревьев', 'Процессор заслуживает особого внимания. Он обязательно понравится геймерам со стажем.', 1),
  ('1/18/2000', null, 'Первая большая ёлка была установлена только в 1938 году.', 'Как перестать беспокоиться и начать жить', 'Из под его пера вышло 8 платиновых альбомов.', 2),
  ('1/18/2001', null, 'Это один из лучших рок-музыкантов.', 'Что такое золотое сечение', 'Бороться с прокрастинацией несложно. Просто действуйте. Маленькими шагами.', 3),
