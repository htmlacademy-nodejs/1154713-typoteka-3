...
INSERT INTO publications(publication_date, picture, full_text, title, announce) VALUES
  ...
  ('2/11/2023', null, 'Он написал больше 30 хитов.', 'Учим HTML и CSS', 'Игры и программирование разные вещи. Не стоит идти в программисты, если вам нравятся только игры.');
